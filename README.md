...
![Main Menu](https://github.com/Michael-Lu-DeerofBlue/Trash-Sorting-Guidance-App-Project/blob/main/Screenshot2.png)  
_Main menu with options for different trash search methods and feedback._

![Trash Search Example](https://github.com/Michael-Lu-DeerofBlue/Trash-Sorting-Guidance-App-Project/blob/main/Screenshot1.png)  
_Example of auto-generating the trash category using a photo and the facility locator._
